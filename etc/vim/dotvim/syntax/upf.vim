...
syn keyword upfCommand add_domain_elements create_logic_port create_logic_net connect_logic_net
...
syn keyword upfCommand set_retention_control set_port_attributes
syn keyword upfCommand        set_related_supply_net set_related_supply_net set_level_shifter add_power_state load_upf create_supply_set upf_version 

syn keyword upfParameter       -retention_supply_set -output_supply_set -input_supply_set -source -sink  -object_list -power -isolation_supply_set -supply_expr -supply -update -function -ack_delay
syn keyword upfParameter -ack_port
syn keyword upfParameter  -driver_supply -receiver_supply -all_equivalent
...
syn keyword upfParameter -version -logic_expr
